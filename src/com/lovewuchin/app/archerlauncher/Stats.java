...
public class Stats {
    ...
    public static final String ACTION_LAUNCH = "com.lovewuchin.app.archerlauncher.action.LAUNCH";
    public static final String PERM_LAUNCH = "com.lovewuchin.app.archerlauncher.permission.RECEIVE_LAUNCH_BROADCASTS";
